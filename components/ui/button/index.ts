  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-[color,background-color,_border-color,_shadow] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        elevated:
          "bg-foreground/5 bg-transparent shadow-sm hover:bg-emphasis hover:text-emphasis-foreground hover:shadow-none active:bg-emphasis/50 active:text-foreground active:shadow-none dark:bg-surface-high dark:hover:bg-emphasis dark:active:bg-emphasis/50",
      },
      size: {

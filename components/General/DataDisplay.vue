...
<template>
  <div class="flex w-full flex-col gap-y-8 py-10 xl:pl-8 xl:ml-96">
    ...
    <div class="rounded-xl bg-surface px-2 pt-4 shadow-lg">
      <Tabs default-value="average-os" class="min-h-[600px]">
        ...
        <TabsContent value="osdiff">
          <LazyGeneralOsToTimeChart :data="results.data.osDiffToTime" :title="'Os diff'" :x-label="'os difference'">
            <template #hint>
              <Hint>
        ...
        <TabsContent value="min-os">
          <LazyGeneralOsToTimeChart :data="results.data.minOs" :title="'Min os'" :x-label="'min os'" :max="50" :min="0">
            <template #hint>
              <Hint>
        ...
        <TabsContent value="max-os">
          <LazyGeneralOsToTimeChart :data="results.data.maxOs" :title="'Max os'" :x-label="'max os'" :max="50" :min="0">
            <template #hint>
              <Hint>
    ...
    <LazyGeneralWinrateChart v-if="results.data.factionPreference" class="rounded-xl bg-surface p-2 shadow-lg"
      title="Faction pick" :data="results.data.factionPreference"></LazyGeneralWinrateChart>
